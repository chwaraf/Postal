...
--	self.db = LibStub("AceDB-3.0"):New("Postal3DB", defaults)
	...
	-- Position the options arrow button BELOW the close button (X) to avoid TSM overlay
	Postal_ModuleMenuButton:ClearAllPoints()
	Postal_ModuleMenuButton:SetPoint("TOPRIGHT", "MailFrameCloseButton", "BOTTOMRIGHT", 0, -1)
